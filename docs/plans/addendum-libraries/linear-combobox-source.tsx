// REFERENCE ONLY — verbatim source of damianricobelli/shadcn-linear-combobox
// components/linear-combobox/index.tsx (fetched 2026-07-12).
// Slice A adapts this into a generic register-styled PropertyCombobox wired to
// real block-view select/status cell mutations (src/lib/block-view/database/cells.tsx).
// Changes needed on adoption:
//  - restyle to register utilities (text-cr-*, bg-cr-*), drop hardcoded priorities
//  - take {options, value, onChange} props (controlled, real data), not local demo state
//  - reuse existing @/components/ui/{button,command,popover,tooltip}
//  - drop or vendor the 'p' hotkey + icons (ponytail: hotkey optional)
"use client";
