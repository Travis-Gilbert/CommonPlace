import type { ModelEdge, ModelNode, JoinKey, Cardinality } from "@commonplace/okf";
        ...
        <div className="flex flex-col gap-[12px] p-[11px] pt-[4px]">
          ...
          <div className="flex flex-col gap-[5px]">
            <label htmlFor="rel-cardinality" className="flex items-center gap-[5px] text-[13px] font-semibold text-slate-900">
              Cardinality
              <InfoTip text="How many rows on each side match: 1:1, 1:N, N:1 or N:N. Documentation only — drawn on the canvas, documentation only — not a runtime constraint." />
            </label>
            <select
            ...
            <span className="text-[11.5px] text-slate-400 leading-[1.4]">
              Optional — for modeling/visualization only. Documentation only — not a runtime constraint.
            </span>
          </div>
        </div>
      </details>
