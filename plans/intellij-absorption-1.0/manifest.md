...
| token-kernel-binding | work | agent | floem Style-chain binding for the theorem-style kernel; CSS + Rust-constants dialects; light Lapce theme activation in the fork (bundled themes dir); kernel/binding unit tests. | charted (2026-08-10) |
