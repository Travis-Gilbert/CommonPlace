...
| 2026-08-16 | `https://apps.theoremweb.com` is Theorem apps (`travis-theorem-dioxus`: Dioxus + AgentFS), not CommonPlace Console. Console stays `https://v2.theoremharness.com`. Apex `https://theoremweb.com` still serves Theseus until it is moved to become Theorem's canonical home. `https://context.theoremweb.com` remains Theseus; `https://ide.theoremweb.com` remains Lapce wasm. | User: theoremweb.com is for Theorem; CommonPlace on that host was a mis-point. |
| 2026-08-16 | All theoremweb.com hosting is on Fly. Apex `https://theoremweb.com` and `https://context.theoremweb.com` serve Theseus (`travis-theoremweb`). Console stays `https://apps.theoremweb.com` (`travis-commonplace-console`). Lapce wasm workbench is `https://ide.theoremweb.com` (`travis-theorem-ide`). Vercel remains registrar/DNS only. `https://v2.theoremharness.com` remains a live alias. | Superseded same day: `apps` is Theorem Dioxus, not the console. |
| 2026-08-15 | Product console alias is `https://apps.theoremweb.com`. Apex `https://theoremweb.com` stays the existing Theseus site. `https://v2.theoremharness.com` remains a live alias. | Superseded 2026-08-16: `apps` is Theorem, not the console. |
