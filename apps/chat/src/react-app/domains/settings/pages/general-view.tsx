...
export type GeneralSettingsViewProps = {
  ...
  // Optional: OW1 severed the donor's feedback, community, and issue
  // destinations, and CommonPlace equivalents are opt-in per deployment. An
  // action with nowhere to go is hidden rather than rendered dead.
  onSendFeedback?: () => void;
  onJoinDiscord?: () => void;
  onReportIssue?: () => void;
};
