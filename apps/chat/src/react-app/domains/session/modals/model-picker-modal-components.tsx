    ...
    <div className="mt-5 shrink-0">
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-dls-surface border border-dls-border rounded-xl py-2.5 pl-9 pr-3 text-sm text-dls-text placeholder:text-dls-secondary focus:outline-none focus:ring-1 focus:ring-[color-mix(in_oklab,var(--ij-accent)_20%,transparent)] focus:border-dls-accent"
        />
      </div>
      {props.query.trim() ? (
