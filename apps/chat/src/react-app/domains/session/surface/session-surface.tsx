...
import { GrainOrb, WORKING_ORB_TOKENS } from "../../../design-system/grain-orb";
...
This shared renderer keeps **bold proof text**, inline \`renderMarkdownHtml\`, and [CommonPlace link](https://commonplace.build) readable in one message.
  ...
  const messages: UIMessage[] = [
    ...
    },
    {
      ...
      parts: [
        ...
        {
          type: "text",
          text: "Your plan is drafted — details in [CommonPlace](https://commonplace.build). Search token: chat-transcript-proof.",
        },
      ],
    ...
    <div className="flex justify-start" role="status" aria-live="polite">
      <div className="inline-flex items-center gap-1.5 px-1 py-1 text-[12px] text-dls-secondary">
        <div style={{ width: 20, height: 20, borderRadius: "50%", overflow: "hidden" }}>
          {/* OW3 shader law: compositor orb, no WebGL context. */}
