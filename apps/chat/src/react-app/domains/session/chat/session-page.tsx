...
export function SessionPage(props: SessionPageProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-[radial-gradient(circle_at_top,color-mix(in_oklab,var(--ij-accent)_12%,transparent),transparent_42%),var(--ij-frame)] text-dls-text mac:bg-transparent">
      <SidebarProvider
        open={sidebarOpen}
