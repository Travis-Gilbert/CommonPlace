    ...
    >
      ...
      {panel ? (
        ...
        <>
          ...
          <div
            className={`flex w-full flex-col overflow-y-auto transition-all duration-500 ${
          ...
          {!isCollapsed && (
            <div className="mt-auto w-full border-t border-neutral-800 pt-2">
              <div className="flex items-center gap-2 px-2 py-2">
                ...
                <button
                  type="button"
                  className="ml-auto flex size-8 items-center justify-center rounded-md hover:bg-neutral-800"
                  aria-label="More"
                >
