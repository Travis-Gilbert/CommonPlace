...
export const intuiEditorThemeDark = EditorView.theme(intuiEditorThemeRules, { dark: true });
export const intuiEditorThemeLight = EditorView.theme(intuiEditorThemeRules, { dark: false });
...
const intuiSyntaxHighlighting = syntaxHighlighting(intuiHighlightStyle);

export function intuiEditorExtensions(mode: EditorThemeMode) {
  return [mode === 'dark' ? intuiEditorThemeDark : intuiEditorThemeLight, intuiSyntaxHighlighting];
}
