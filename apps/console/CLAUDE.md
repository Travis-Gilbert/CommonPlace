...
| Chat / console left chrome | 21st.dev `@jshguo/sidebar-component` installed at `components/ui/sidebar-component.tsx` (`TwoLevelSidebarShell`, `@carbon/icons-react`) | icon rail + detail panel; never hand-roll a lookalike |
