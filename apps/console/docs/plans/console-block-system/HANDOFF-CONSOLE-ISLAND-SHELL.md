...
4. `CardView` and `RecordTableView` files contain no radius, border, shadow, or background
   styling of their own.
5. Blurring the window applies the 0.44 overlay; refocusing removes it.
6. `pnpm gates` passes.
