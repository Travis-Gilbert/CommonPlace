...
// for composer `/` does not need every Console surface compiled.
export default defineConfig({
  ...base,
  globalSetup: undefined,
  testDir: './e2e',
  testMatch: 'commands-slash-palette.spec.ts',
  timeout: 180_000,
  webServer: [
    {
    ...
    },
    {
      ...
      env: {
        ...
        CONSOLE_E2E_WORKSPACE_ID: 'workspace-e2e',
        CONSOLE_E2E_WORKSPACE_SLUG: 'e2e',
        CONSOLE_E2E_SCOPE_REF: 'workspace:workspace-e2e',
