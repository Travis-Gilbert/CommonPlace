...
// directory and cause PostCSS or module-resolution deadlocks. Web scripts run
// from apps/web, so ../.. is the repository root.
...
// web/Railway/Vercel build is unaffected (it stays a server build with rewrites + route
