...
type StatusIcon = React.ComponentType<{ className?: string; "data-slot"?: string }>;
const statusIconMap: Record<ToolStatus, StatusIcon> = {
  running: LoaderIcon as StatusIcon,
  complete: CheckIcon as StatusIcon,
  incomplete: XCircleIcon as StatusIcon,
  "requires-action": AlertCircleIcon as StatusIcon,
};
