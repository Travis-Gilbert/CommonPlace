      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            mode: 'view',
            viewType: 'agent-thread',
            viewContext: { agentId: 'claude', agentMode: 'acp' },
          },
          {
            label: 'Codex',
            href: '#agent-codex',
            ...
            mode: 'view',
            viewType: 'agent-thread',
            viewContext: { agentId: 'codex', agentMode: 'acp' },
          },
          {
            label: 'Gemini CLI',
            href: '#agent-gemini',
            ...
            mode: 'view',
            viewType: 'agent-thread',
            viewContext: { agentId: 'gemini', agentMode: 'acp' },
          },
        ],
      },
      {
        ...
        expandable: true,
        children: [
          { label: 'Co-browser', href: '#cobrowser', icon: 'globe', mode: 'screen', screenType: 'cobrowser' },
          { label: 'Coordination', href: '#coordination', icon: 'chat', mode: 'screen', screenType: 'coordination' },
          { label: 'Receiver', href: '#receiver', icon: 'inbox', mode: 'screen', screenType: 'receiver' },
        ],
      },
      {
        label: 'Engine',
