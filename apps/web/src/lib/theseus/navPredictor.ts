...
// Only actions with real wired handlers live here. `tensions`, `sources`,
// and `investigate` were previously surfaced by the predictor but their
// handlers were no-op console.warns in AskExperience; they were removed
// from this catalog so the predictor can never rank and surface them.
// Re-add them only once their handlers open real drawers.
