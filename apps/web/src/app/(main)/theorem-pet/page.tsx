...
// (@/components/rough) for cards and dividers; the lone arrow is an inline lucide-style SVG (no icon-lib
// import); the gate-check list is trivial static markup. Page-level composition otherwise.
...
export default function TheoremPetPage() {
  return (
    <div className="space-y-12 py-4 sm:py-8">
      ...
      <section className="flex flex-wrap gap-x-6 gap-y-2 border-t border-ink/10 pt-6 text-sm text-ink-secondary">
        <span>
