...
type Item = { id: string; kind: string; title: string; created: string; validFrom: string };

const ITEMS: Item[] = [
  { id: 'itm_9f2a', kind: 'file', title: 'Ordinance 24-113, porch lighting and setbacks.pdf', created: '2026-07-02', validFrom: '2026-06-18' },
  { id: 'itm_7c11', kind: 'link', title: 'How ADHD brains use external memory systems', created: '2026-07-02', validFrom: '—' },
  { id: 'itm_5b83', kind: 'note', title: 'Voice note, 47 seconds (transcribed)', created: '2026-07-01', validFrom: '—' },
  ...
  { id: 'itm_1f57', kind: 'note', title: 'Pairformer scatter-add kernel notes', created: '2026-06-29', validFrom: '—' },
  { id: 'itm_0c3b', kind: 'source', title: '2019 zoning map, Genesee County', created: '2026-06-28', validFrom: '2019-01-01' },
  { id: 'itm_e81d', kind: 'link', title: 'Elicit corpus-table extraction pattern', created: '2026-06-27', validFrom: '—' },
];
...
export default function TimelinePage() {
  ...
  const ordered = useMemo(() => {
    const rows = ITEMS.map((i) => {
      ...
      return { ...i, when, other, hasWhen: when !== '—' };
    });
    return rows.sort((a, b) => {
      if (a.hasWhen && b.hasWhen) return b.when.localeCompare(a.when);
              ...
              <div className={styles.card}>
                ...
                <div className={styles.meta}>
                  ...
                  <span className={styles.other}>
                    {basis === 'valid' ? 'created' : 'valid from'} {i.other}
                  </span>
                </div>
              </div>
            </div>
