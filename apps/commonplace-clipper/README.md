# CommonPlace Web Clipper

This CommonPlace-owned app preserves the upstream highlighter, reader,
extraction, template, interpreter, and browser-extension surfaces. CommonPlace
captures use the versioned `@commonplace/capture-client` boundary and a
background-worker queue that survives browser restarts.

The upstream README content remains below for extension usage and maintenance context.
